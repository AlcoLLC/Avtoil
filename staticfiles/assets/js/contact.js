document.addEventListener('DOMContentLoaded', function () {
  ...
  const firstOption =
    document.querySelector('.custom-option[data-value="buy"]') ||
  ...
  function showRecaptchaError(message) {
    ...
    if (recaptchaContainer) {
      ...
      errorDiv.style.cssText =
        'color: #d32f2f; font-size: 14px; margin-top: 5px; padding: 8px; background: #ffebee; border: 1px solid #ffcdd2; border-radius: 4px;';
